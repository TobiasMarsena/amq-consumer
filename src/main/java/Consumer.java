...
public class Consumer {
    ...
    public static void main(String[] args) throws JMSException {
    	 ...
    	 *  ActiveMQ.
    	 */
        JmsConnectionFactory factory = new JmsConnectionFactory("amqp://amq-broker-amqp-0-svc.amq-dev.svc.cluster.local:5672?jms.clientID=Tobias&jms.username=admin&jms.password=admin");
